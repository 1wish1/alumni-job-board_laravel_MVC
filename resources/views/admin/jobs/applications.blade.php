            ...
            <div class="col-md-6">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <a href="{{ $application->resume_link }}" target="_blank" class="btn btn-sm btn-outline-primary mb-2">View Resume</a>
                        <div class="mb-2">
                            @php
                        ...
                        <form action="{{ route('admin.applications.update', $application) }}" method="POST" class="d-flex flex-column gap-1">
                            ...
                            <input type="text" name="message" class="form-control form-control-sm" value="{{ $application->message }}" placeholder="Add message">
